...
/// # Spinnable, Resizable
///  Provides the ability to scale, rotate, and spin the view. Throw the rotation handle and watch it go.
...
public struct SpinnableResizable: ViewModifier {
