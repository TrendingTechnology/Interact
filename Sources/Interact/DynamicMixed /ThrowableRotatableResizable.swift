//
//  ThrowableRotatableResizable.swift
//  
//
...
/// # Throwable, Resizable and Rotatable
///  Provides the ability to scale, rotate,  resize, drag and throw the view.
    ...
    private func getTopLeading(proxy: GeometryProxy) -> some View{
        self.handle
            ...
            .gesture(
                ...
                .onEnded { (value) in
                    self.velocityModel.offset.width += cos(self.angle)*value.translation.width/2 - sin(self.angle)*value.translation.height/2
                    self.velocityModel.offset.height += cos(self.angle)*value.translation.height/2 + sin(self.angle)*value.translation.width/2
